  ...
  <div class="input-group-prepend">
    ...
    <div class="container-fluid">
      <div class="mt--6">
        ...
        <div class="row">
          <div class="col-xl-12">
            <main-table @edit="updateToggle" v-if="files.length!==0" :rows="files" title="Files Rules"/>
...
export default {
 ...
 async fetch() {
  ...
  var data={file: document.getElementById("file").value,
      desc: document.getElementById("desc").value , impact:document.getElementById("impact").value};

      await this.$axios.post(`${url}/addfile`,data)
         .then(response => {
           if(response.status!==200){
             //this.loaded.responseError=true;
  ...
  updateToggle(value){
    ...
    document.getElementById("file").value=value.row.file;
  ...
  var data={file: document.getElementById("file").value,
      ...
      await this.$axios.put(`${url}/editfile/`+this.editIndex,data)
         .then(response => {
           if(response.status!==200){
             //this.loaded.responseError=true;
